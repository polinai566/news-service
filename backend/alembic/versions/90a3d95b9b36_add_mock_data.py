...
def upgrade() -> None:
    ...
    op.execute(
        '''
            INSERT INTO "user" (user_id, user_name, login, registration_date, avatar, user_role, password)
            VALUES
                    (1, 'polina', 'polinam566', '2025-11-05 00:00:00', 'polina_ava.jpg', 'admin', '$argon2id$v=19$m=65536,t=3,p=4$U080gdtNdY2QEbp3K5olsA$d6OS6ZzUCBSDDFHKWN/1ba2ZVkkpluwnl5jbTIdvVjw'),
                    (2, 'mitya', 'mityap456', '2025-11-05 01:00:00', 'mitya_ava.jpg', 'author', '$argon2id$v=19$m=65536,t=3,p=4$buZBbG9zDDo5CgOgCbD22w$Xx78I9aX3VgF2pYwH3Seim3ojgWWoRbCTNyqK/t+nPE'),
                    (3, 'seryozha', 'seryozhak356', '2025-11-05 02:00:00', 'seryozha_ava.jpg', 'user', '$argon2id$v=19$m=65536,t=3,p=4$zO1CdR9CsRBnACV460z7+Q$WuCaZzWpy1/NWJyXn+w3DO5HSYfH8uqPmiMouKtvjwc')
        '''
    )
    # создание новости
    op.execute(
